...
- [Errors as values: Result](learn/04-result.md)
- [Your own types: ADTs and exhaustive match](learn/05-adts-and-match.md)
- [Records](learn/06-records.md)
- [Lists, sets, and maps](learn/07-collections.md)
- [Tuples and destructuring](learn/08-tuples.md)
- [Typed holes and type-driven development](learn/09-typed-holes.md)
- [Mutation, on purpose](learn/10-mutation.md)
- [Effects, inferred](learn/11-effects.md)
- [Talking to Python: extern](learn/12-python-interop.md)
- [Computation expressions](learn/13-computation-expressions.md)
