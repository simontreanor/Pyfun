...
Pyfun's pitch is that the compiler is the gatekeeper, so the compiler's voice matters. Both
[CLAUDE.md](https://github.com/simontreanor/Pyfun/blob/main/CLAUDE.md) and
[DESIGN.md §3](https://github.com/simontreanor/Pyfun/blob/main/DESIGN.md) put it plainly: syntax
